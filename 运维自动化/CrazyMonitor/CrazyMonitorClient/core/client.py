...
class ClientHandle(object):
    ...
    def invoke_plugin(self, service_name, val):
        ...
        :param val: [pulgin_name,monitor_interval,last_run_time]        Mysql:[MySqlPlugin,60,0]
        :return:
        """
        plugin_name = val[0]
    ...
    def url_request(self, action, url, **extra_data):
        ...
        if action in ('get', 'GET'):
            ...
            try:
                ...
                req = requests.post(url=abs_url, data=extra_data['params'], timeout=settings.configs['RequestTimeout'])
                req_data = req.text
